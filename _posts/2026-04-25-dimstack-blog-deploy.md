...
> **摘要**：本文记录了将 Dim Stack 博客系统通过 Docker Compose 部署到云服务器的过程，涵盖 Dockerfile 适配、docker-compose 编排、MySQL 中文乱码修复、NPM 反向代理配置等关键环节。适合想搭建个人博客的开发者参考。
>
...
这篇文章就是这两天的记录。如果你也想自己搭一个博客，希望能帮你省下一些时间。
