...
> **摘要**：产品经理用 AI，大多数时候只是用来写文档、改措辞。但 Paweł Huryn（Product Compass 创始人）构建的 PM Skills Marketplace，把 Teresa Torres、Marty Cagan、Alberto Savoia 等产品专家的方法论编码成了 65 个 AI 技能和 36 条链式工作流。本文解析这套系统的架构、8 大模块、核心技能，以及如何将其融入 AI 驱动的开发流程。

## 楔子

产品经理用 AI，最常见的场景是「帮我写个 PRD」「帮我分析一下竞品」。这些一次性问答产出的文档质量取决于你的 prompt 质量，而且 AI 不会主动提醒你遗漏了什么。有没有更好的方式？

## 引言

本文解析 PM Skills Marketplace 这套产品方法论 AI 技能系统的架构设计，覆盖 8 大模块、65 个技能、36 条链式工作流，并探讨如何将其融入 AI 驱动的软件开发流程。

## 目录

- [楔子](#楔子)
- [引言](#引言)
- [产品经理的 AI 困境](#产品经理的 AI 困境)
- [什么是 PM Skills Marketplace](#什么是 PM Skills Marketplace)
- [8 大模块详解](#8 大模块详解)
- [Skills vs Commands：理解两层架构](#Skills vs Commands：理解两层架构)
- [安装和使用](#安装和使用)
- [如何融入 AI 驱动的开发流程](#如何融入 AI 驱动的开发流程)
- [方法论来源](#方法论来源)
- [适合谁用](#适合谁用)
- [总结](#总结)
...
### pm-product-discovery（产品发现）— 13 技能 + 5 命令
...
### pm-product-strategy（产品战略）— 12 技能 + 5 命令
...
### pm-market-research（市场研究）— 7 技能 + 3 命令
...
### pm-data-analytics（数据分析）— 3 技能 + 3 命令
...
### pm-go-to-market（上市策略）— 6 技能 + 3 命令
...
### pm-marketing-growth（营销增长）— 5 技能 + 2 命令
...
PM Skills Marketplace 的技能不是凭空设计的，而是基于这些产品专家的方法论：
